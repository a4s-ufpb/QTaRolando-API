...
// public static Event customizedEvent(String title, String subtitle, Integer
// categoryId, String description,
...
// return new Event(title, subtitle, categoryId, description,
// initialDateConverted, finalDateConverted, imagePath, eventModalityId,
// location,
// phone, site);
// }
