...
// BDDMockito.when(eventServiceMock.getEventsByFilter(ArgumentMatchers.anyString(),
...
// Page<Event> events = eventController.getEventsByFilter(expectedTitle, 1L,
// "PRESENCIAL",
...
// EventCreator.defaultEvent().getCategories().get(0).getId();
// String expectedCategoryName =
// EventCreator.defaultEvent().getCategories().get(0).getName();

// Page<Event> events = eventController.getEventsByFilter("Praia",
// expectedCategoryId, "PRESENCIAL",
// "dateType", "initialDate", "finalDate",1,1);
...
// @Test
// void
// getEventsByFilter_ReturnsListOfEventsByEventModalityWith_Presencial_Modality(){
// String expectedModalityDescription =
// EventCreator.defaultEvent().getModality().getDescription();
// int expectedModalityId = EventCreator.defaultEvent().getModality().getCod();

// Page<Event> events = eventController.getEventsByFilter("Praia", 1L,
// expectedModalityDescription,
// "dateType", "initialDate", "finalDate",1,1);
...
// @Test
// void
// getEventsByFilter_ReturnsListOfEventsByEventModalityWith_Online_Modality(){
// Event eventWithOnlineModality = EventCreator.defaultEvent();
// eventWithOnlineModality.setModality("ONLINE");

// String expectedModalityDescription =
// eventWithOnlineModality.getModality().getDescription();
...
// Assertions.assertThatCode(() -> eventController.updateEvent(idToBeReplaced,
// eventDTO))
// .doesNotThrowAnyException();
