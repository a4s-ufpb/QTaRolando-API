...
// List<Event> response = testRestTemplate.exchange("/api/events",
// HttpMethod.GET, null,
...
// @Test
// @DisplayName("getEventsByTitle returns an empty list of event when event is
// not found")
...
// @Test
// @DisplayName("getEventsByTitleContaining returns a list of event with the
// letters specified when successful")
// public void getEventsByTitleContaining_ShouldReturnListOfEvent() {
// Event savedEvent =
// eventRepository.save(EventCreator.customizedEventTitle("Praia"));
// Event savedEvent2 =
// eventRepository.save(EventCreator.customizedEventTitle("Praça"));
...
// Event response = testRestTemplate.getForObject("/api/events/{id}",
// Event.class, expectedId);
...
// @DisplayName("shouldFindEventsPaginados return the elements in the first
// page")
// @Test
...
// PageableResponse<Event> eventPage = testRestTemplate.exchange(url,
// HttpMethod.GET, null,
...
// Event savedEvent =
// eventRepository.save(EventCreator.customizedEventTitleAndDate(
